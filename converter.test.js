...
const returnHeaderWithDurations = [
  'Depart • Thu, Oct 9',
  '31h 25m',
  'Austrian Airlines',
  ...
  'Vienna Intl (VIE)',
  'Light meal (fee)',
  '3h 25m•Change planes in Vienna (VIE)',
  'Long layover',
  'Austrian Airlines',
  'Austrian Airlines 457',
  'Airbus A320neo',
  '8:20 pm',
  'Vienna Intl (VIE)',
  '2h 20m',
  '9:40 pm',
  'London Heathrow (LHR)',
  '12h 55m•Change planes in London (LHR)',
  'Long layover',
  'Austrian Airlines',
  'Austrian Airlines 7857 · Operated by United Airlines',
  'Boeing 777',
  ...
  'London Heathrow (LHR)',
  'Arrives Fri, Oct 17',
  '3h 00m•Change planes in London (LHR)',
  'Long layover',
  'Austrian Airlines',
  ...
  'Vienna Intl (VIE)',
  'Light meal (fee)',
  '1h 45m•Change planes in Vienna (VIE)',
  'Austrian Airlines',
...
const returnHeaderWithDurationsOutput = window.convertTextToI(returnHeaderWithDurations).split('\n');
assert.ok(/16OCT/.test(returnHeaderWithDurationsOutput[3] || ''), 'return section with durations should keep Oct 16 on the SFO-LHR leg');
